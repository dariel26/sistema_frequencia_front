    ...
    return (
        <div className="d-flex bg-light"
            ...
            <div className="d-flex flex-column bg-menu-primary h-100" id="my-left"
                ...
                <button className="btn btn-menu-dark-dark d-flex w-100 p-0"
                    ...
                    <div className="d-flex h-100 text-light justify-content-center align-items-center" id="my-left-icon"
                        style={isClosed
                            ? { width: "50px", transition: "transform 300ms", transform: "rotateY(180deg)" }
            ...
            <div className="h-100 w-100 position-absolute" style={isClosedFixed ?
                { display: "none" } : { display: "flex", zIndex: "50" }} />
            <div className="d-flex flex-column h-100" id="my-right"
                style={{ width: "calc(100% - 200px)", transition: "width 300ms" }}>
                <div className="d-flex bg-menu-primary w-100 border-bottom" id="my-top"
                    style={isClosedFixed
                        ? { height: "0px", transition: "height 300ms" }
                        : { height: "0px", transition: "height 300ms", filter: "brightness(50%)" }}>
                                ...
                                <ul className="dropdown-menu bg-menu-dark-dark">
                                    {
                                        props.actions.map((action, index) => (
                                            <li key={index}>
                                                <button
                                                    className="btn-menu-dark-light dropdown-item d-flex text-light bg-menu-dark-dark align-items-center"
                ...
                <div className="d-flex w-100 h-100 bg-light" id="my-bottom" style={isClosedFixed ? {} : { filter: "brightness(50%)" }}>
                    <Outlet />
                </div>
            </div>
        </div>
